...
pub async fn bulk(configuration: &configuration::Configuration, body: &str) -> Result<models::BulkResponse, Error<BulkError>> {
...
pub async fn delete(configuration: &configuration::Configuration, delete_document_request: models::DeleteDocumentRequest) -> Result<models::DeleteResponse, Error<DeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn insert(configuration: &configuration::Configuration, insert_document_request: models::InsertDocumentRequest) -> Result<models::SuccessResponse, Error<InsertError>> {
    let local_var_configuration = configuration;
...
pub async fn replace(configuration: &configuration::Configuration, insert_document_request: models::InsertDocumentRequest) -> Result<models::SuccessResponse, Error<ReplaceError>> {
    let local_var_configuration = configuration;
...
pub async fn update(configuration: &configuration::Configuration, update_document_request: models::UpdateDocumentRequest) -> Result<models::UpdateResponse, Error<UpdateError>> {
    let local_var_configuration = configuration;
