...
pub async fn percolate(configuration: &configuration::Configuration, index: &str, percolate_request: models::PercolateRequest) -> Result<models::SearchResponse, Error<PercolateError>> {
...
pub async fn search(configuration: &configuration::Configuration, search_request: models::SearchRequest) -> Result<models::SearchResponse, Error<SearchError>> {
    let local_var_configuration = configuration;
