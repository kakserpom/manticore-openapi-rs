...
> models::DeleteResponse delete(delete_document_request)
...
> models::SuccessResponse insert(insert_document_request)
...
> models::SuccessResponse replace(insert_document_request)
...
> models::UpdateResponse update(update_document_request)
